...
#### (★) 순서 매기기를 통한 '식사하는 철학자 문제' 해결(Ordering or Resources/Resource Hierarchy Solution)
...
아 반복문의 반복 횟수를 무한히 늘리면, 상술했듯 <strong class="r">1번과 N번 철학자의 식사 확률은 나머지의 절반에 수렴</strong>하게 되는 것도 보일 수 있다.
